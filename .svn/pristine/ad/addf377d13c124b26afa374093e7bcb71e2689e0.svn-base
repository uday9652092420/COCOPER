...
const primaryItems: NavItem[] = [
  ...
  { to: '/masters/user-permissions', label: 'User Permission', icon: <KeyRound className="h-4 w-4" />, module: 'user-permission' },
...
const masterItems: NavItem[] = [
  { to: '/masters/branch-master', label: 'Branch Master', icon: <Network className="h-4 w-4" />, module: 'branch-master' },
...
const reportItems: NavItem[] = [
  { to: '/reports/purchase-register', label: 'Purchase Register', icon: <FileText className="h-4 w-4" />, module: 'purchase-register' },
  { to: '/reports/sales-register', label: 'Sales Register', icon: <FileText className="h-4 w-4" />, module: 'sales-register' },
  { to: '/reports/supplier-statement', label: 'Supplier Statement', icon: <BarChart3 className="h-4 w-4" />, module: 'supplier-statement' },
