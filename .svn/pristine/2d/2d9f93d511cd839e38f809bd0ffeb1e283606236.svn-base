...
export const MasterFormModal = <TValues extends FieldValues>({
  ...
  const submitAndNew = (values: TValues) => {
    onSave(values, true)
    reset({} as DefaultValues<TValues>)
  }
      ...
      <div className="max-h-full w-full max-w-3xl overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        >
              ...
              <div key={field.name} className="text-xs">
                ...
                {field.type === 'textarea' ? (
                  ...
                  <textarea
                    ...
                    ${field.readOnly ? 'bg-slate-100 cursor-not-allowed' : ''}`}
                ...
                {errors[field.name as keyof TValues] && (
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-3 text-xs">
            ...
            <button
              type="button"
              onClick={() => reset(defaultValues as DefaultValues<TValues>)}
